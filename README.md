...
An awesome node module to fetch weather information! 🌤️🌡️🌬️

## Features

- Supports both Fahrenheit and Celsius formats 🌡️❄️🌡️
- Provides detailed weather information, including:
  - Weather feels like 🌡️🌡️
  - Temperature 🌡️
  - Wind degree and direction 🌬️🧭
  - Wind speed in KPH and MPH 💨
  - Precipitation in inches and millimeters ☔
  - Pressure in inches and millibars 📊
  - GUST speed in KPH and MPH 💨💨
  - Humidity 💧
  - Air quality 🌬️🌱
  - Weather conditions 🌥️🌦️🌧️🌩️☀️

## Usage (JavaScript):

```js
const { getWeather } = require("weathery.js");
...
async function logWeather() {
  ...
  const w = await getWeather("Tangail", "C");
...
```ts
import { getWeather, DegreeType } from "weathery.js";
...
Now you can enjoy using the Weathery JS module to fetch weather information and log it in a friendly and informative way! ☁️🌈🌤️
